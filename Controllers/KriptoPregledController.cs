...
{
    public class KriptoPregledController : Controller
    {
        private readonly KriptoDBContext _context;

        public KriptoPregledController(KriptoDBContext context)
        {
            _context = context;
        }
        ...
        // GET: KriptoPregled/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: KriptoPregled/Create
